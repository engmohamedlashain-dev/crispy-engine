...
class SuraContent extends StatelessWidget {
  ...
  static const String routeName="sura_contenet";
   SuraContent({super.key,required this.suracontent,required this.index, required this.isselect
   });
...
padding: EdgeInsets.symmetric(
  vertical: height*.02,
          ...
          color:
          isselect ? AppColor.gold:
          AppColor.trnsparentColor
              ,
