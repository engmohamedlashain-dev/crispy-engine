      ...
      body: Column(
            children: [
              Row(
                ...
                children: [
                  Image.asset(AppAssest.leftcorner,

                  ),
                  Text(QuranResource.quranSurahs[index],style:
                  AppTextStyle.gold20
                 ),
                  Image.asset(AppAssest.rightcorner,
               ),
                      ...
                      (itemBuilder:
                        ...
                        (context, index) =>
                         ...
                         onTap: () {
                          ...
                          SuraContent(suracontent: versess[index],index:index,isselect:selectIndex == index
